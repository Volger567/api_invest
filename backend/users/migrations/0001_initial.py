    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default_share', models.PositiveIntegerField(default=0, verbose_name='Доля по умолчанию')),
                ...
                ('investor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='co_owned_investor_accounts', to=settings.AUTH_USER_MODEL, verbose_name='Инвестор')),
            ],
            options={
